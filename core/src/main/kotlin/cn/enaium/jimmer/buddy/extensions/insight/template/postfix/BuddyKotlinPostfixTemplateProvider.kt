 ...
 * @author Enaium
 */
class BuddyKotlinPostfixTemplateProvider : AbstractBuddyPostfixTemplateProvider() {

    val builtinTemplates = setOf<PostfixTemplate>(
        KotlinIsLoadedPostfixTemplate(this),
        KotlinFromStringPostfixTemplate(this),
        KotlinUnloadPostfixTemplate(this),
        KotlinShowPostfixTemplate(this),
        KotlinHidePostfixTemplate(this),
        KotlinSetPostfixTemplate(this),
        KotlinBaseQueryPostfixTemplate(this),
        KotlinQueryPostfixTemplate(this),
        KotlinExecuteQueryPostfixTemplate(this),
        KotlinUpdatePostfixTemplate(this),
        KotlinExecuteUpdatePostfixTemplate(this),
        KotlinDeletePostfixTemplate(this),
        KotlinExecuteDeletePostfixTemplate(this),
