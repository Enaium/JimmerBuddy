...
class BuddySettingUI : Configurable {
    ...
    val model = Model().also {
        ...
        it.filterGeneratedFilesInSearch = JimmerBuddySetting.INSTANCE.state.filterGeneratedFilesInSearch
    }
    ...
    override fun createComponent(): JComponent {
        return panel {
            ...
            row {
                textField().align(Align.FILL).bindText(model.srcSetsProperty).label(I18n.message("setting.srcSets"))
            }
            row {
                checkBox(I18n.message("setting.filterGeneratedFilesInSearch")).bindSelected(model.filterGeneratedFilesInSearchProperty)
            }
        }
    }
    ...
    override fun isModified(): Boolean {
        return model.icon != JimmerBuddySetting.INSTANCE.state.icon
                ...
                || model.srcSets != JimmerBuddySetting.INSTANCE.state.srcSets
                || model.filterGeneratedFilesInSearch != JimmerBuddySetting.INSTANCE.state.filterGeneratedFilesInSearch
    }
    ...
    override fun apply() {
        ...
        JimmerBuddySetting.INSTANCE.state.srcSets = model.srcSets
        JimmerBuddySetting.INSTANCE.state.filterGeneratedFilesInSearch = model.filterGeneratedFilesInSearch
    }
    ...
    class Model : BaseState() {
        ...
        val srcSetsProperty = graph.property("main,test,jvmMain,androidMain")
        val filterGeneratedFilesInSearchProperty = graph.property(true)
        ...
        var srcSets by srcSetsProperty
        var filterGeneratedFilesInSearch by filterGeneratedFilesInSearchProperty
    }
}