...
class JimmerProjectPanel(propertyGraph: PropertyGraph, private val wizardContext: WizardContext, builder: Panel) {
    ...
    init {
        builder.panel {
            ...
            row("Type:") {
                JimmerBuddy.Services.UI.segmentedButtonText(this, JimmerProjectModel.Type.entries) {
                    it.text
            ...
            row("Language:") {
                JimmerBuddy.Services.UI.segmentedButtonText(this, JimmerProjectModel.Language.entries) {
                    it.text
            ...
            row("Builder:") {
                JimmerBuddy.Services.UI.segmentedButtonText(this, JimmerProjectModel.Builder.entries) {
                    it.text
