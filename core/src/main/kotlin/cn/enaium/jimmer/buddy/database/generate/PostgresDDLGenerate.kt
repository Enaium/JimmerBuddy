...
class PostgresDDLGenerate(generateDDLModel: GenerateDDLModel) : DDLGenerate(generateDDLModel) {
    override fun typeMapping(type: String): String {
        return when (type) {
            ...
            Int::class.java.name, Integer::class.qualifiedName, Int::class.qualifiedName -> "integer"
            Long::class.java.name, java.lang.Long::class.qualifiedName, Long::class.qualifiedName -> "bigint"
            Boolean::class.java.name, java.lang.Boolean::class.qualifiedName, Boolean::class.qualifiedName -> "bool"
            Float::class.java.name, java.lang.Float::class.qualifiedName, Float::class.qualifiedName -> "real"
            Double::class.java.name, java.lang.Double::class.qualifiedName, Double::class.qualifiedName -> "double precision"
            ...
            InetAddress::class.qualifiedName -> "inet"
            else -> "any"
        }
    }
}